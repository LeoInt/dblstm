...
int main(int argc, char* argv[]) {
   ...
   //Malloc((void**)&x_in, seqLength*input_dim*sizeof(float)); //pinned memory
  ...
  //cudaMemcpy( x_in_d, x_in, seqLength * input_dim *sizeof(float), cudaMemcpyHostToDevice);
 	...
 	Print_matrix_to_file("Xout.txt", x_out, output_dim, seqLength, 1);
